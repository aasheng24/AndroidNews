package a.a.sheng.shengnews.core.prefs;
...
public class PreferenceHelperImpl implements PreferenceHelper {
    ...
    PreferenceHelperImpl() {
        mPreferences = NewsApplication.getInstance().getSharedPreferences(Constants.MY_SHARED_PREFERENCE, Context.MODE_PRIVATE);
    }
